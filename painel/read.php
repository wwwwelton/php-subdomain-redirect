...
<head>
    ...
    <title>Informações do Redirecionamento</title>
</head>
    ...
    <div class="span10 offset1">
        <div class="card">
            <div class="card-header">
                <h3 class="well">Informações do Redirecionamento</h3>
            </div>
            <div class="container py-3">
                <div class="form-horizontal">
                    <div class="control-group">
                        <label class="control-label">Nome do subdominio</label>
                        <div class="controls form-control">
                            <label class="carousel-inner">
                                <?php echo $data['subdominio']; ?>
                            </label>
                        </div>
                    </div>
